...
Get [simpleRouter v0.6](https://github.com/ttsubo/simpleRouter/releases/tag/v0.6) and deploy the code in your LinuxBox. 
...
(1) Check Port Information  
	...
	$ cd simpleRouter-0.6/rest-client
	$ ./get_interface.sh 
	======================================================================
	get_interface
	======================================================================
